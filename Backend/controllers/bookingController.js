...
export const getAdminBookings = async (req, res) => {
  try {
    ...
    // ❌ invalid bookings identify karo
    const invalidBookings = bookings.filter((b) => !b.userId || !b.eventId);
    ...
    // ✅ sirf valid data bhejo
    const validBookings = bookings.filter((b) => b.userId && b.eventId);
