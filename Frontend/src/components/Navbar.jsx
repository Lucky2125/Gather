...
const Navbar = () => {
    ...
    return (
        <nav className="bg-linear-to-r from-slate-950 via-slate-900 to-slate-950 backdrop-blur-xl border-b border-slate-800 shadow-2xl sticky top-0 z-50">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center py-4">
                    {/* Logo */}
                    <Link 
                        to="/" 
                        className="flex items-center gap-2 text-white text-2xl font-bold transition-colors duration-200"
                        onClick={handleNavClick}
                    >
                        <div className="bg-linear-to-br from-blue-500 to-indigo-600 p-2 rounded-lg">
                            <FaTicketAlt className="w-6 h-6" />
                        </div>
                        <span className="hidden sm:inline hover:text-blue-400 transition duration-200">Gather Grid</span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        {user ? (
                            <>
                                ...
                                <div className="flex items-center gap-3 pl-4 border-l border-slate-700">
                                    ...
                                    <button 
                                        ...
                                        className="flex items-center gap-2 bg-linear-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white px-5 py-2 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
                                    >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link 
                                    to="/register" 
                                    className="flex items-center gap-2 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-5 py-2 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
                                >
                        ...
                        {user ? (
                            <>
                                ...
                                <div className="px-4 py-3 border-t border-slate-700 mt-3">
                                    ...
                                    <button 
                                        onClick={handleLogout} 
                                        className="w-full flex items-center justify-center gap-2 bg-linear-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200"
                                    >
                                        <LogOut className="w-4 h-4" />
                                        Logout
                                    </button>
                            ...
                            <div className="space-y-3 px-4 py-3 border-t border-slate-700 mt-3">
                                ...
                                <Link 
                                    to="/register" 
                                    className="flex items-center justify-center gap-2 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 w-full"
                                    onClick={handleNavClick}
                                >
                                    <UserPlus className="w-5 h-5" />
                                    Sign Up
